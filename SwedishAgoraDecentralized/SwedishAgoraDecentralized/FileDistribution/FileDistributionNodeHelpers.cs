...
namespace SwedishAgoraDecentralized.FileDistribution
{
    ...
    {
        internal const int FilePacketSize = 1024;
        internal const int ServerPort = 8888;
        internal static readonly Encoding ProtocolEncoding = Encoding.ASCII;

        internal static string GetUniqueServerId() => Guid.NewGuid().ToString();
